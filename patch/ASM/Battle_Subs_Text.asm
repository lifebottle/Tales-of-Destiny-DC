...
Line_219:
    ...
    .halfword 0x0       ; start  
    .halfword 0xFFFF    ; end
    .asciiz COLOR_START,MARY,COLOR_END,": This should take them out!"
    .align 4
...
Line_2A2:
    ...
    .halfword 0x0       ; start  
    .halfword 0xFFFF    ; end
    .asciiz COLOR_START,JOHNNY,COLOR_END,": Yeah!"
    .align 4
...
Line_363:
    ...
    .halfword 0x0       ; start  
    .halfword 0xFFFF    ; end
    .asciiz COLOR_START,LILITH,COLOR_END,": Now spread the word..."
    .align 4
