...
When you translate something, you only need to modify the text under the #WRITE ...
Of course, both the comment //Text and #WRITE needs to stay unchanged. You only need to modify the japanese text under.
